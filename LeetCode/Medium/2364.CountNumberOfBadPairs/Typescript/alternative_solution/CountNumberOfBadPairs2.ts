...
function numOfBadPairs(arr1 : number[]) : number {
    var goodPairCount : number = 0, totalPairs : number = arr1.length * (arr1.length - 1) / 2;  // dw, it doesn't matter whether division occurs before or after multiplication
...
function main() : void {
    ...
    console.log(`The number of bad pairs in the given array is : ${numOfBadPairs(array1)}`);
}
