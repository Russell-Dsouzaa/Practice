...
function addTwoNumbers(LL1,LL2) {
    var LL3 = new LinkedList(), result = 0, carry = 0, curr1 = LL1.head, curr2 = LL2.head, dummy = new Node(0), curr3 = dummy;
...
Learnings :- 
    ...
    1. At LOC 4, we could've used 'const var_name = require(); too. But then we would have to call those classes with the var_name such as : var LL1 = new var_name.LinkedList();
