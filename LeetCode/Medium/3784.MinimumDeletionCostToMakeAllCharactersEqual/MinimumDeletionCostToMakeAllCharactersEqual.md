### Link to the LeetCode problem : [Here](https://leetcode.com/problems/minimum-deletion-cost-to-make-all-characters-equal/?envType=problem-list-v2&envId=2slp3qde)
