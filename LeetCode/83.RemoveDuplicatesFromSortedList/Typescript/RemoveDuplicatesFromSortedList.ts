...
Learnings :-
    ...
    3. Keeping point 2. in mind, .append() .remove() etc methods are avaible in LinkedList(new1) only, not in Node whereas .next and .size property is avaiable only in Node, not in LinkedList
*/