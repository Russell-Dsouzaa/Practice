...
function main() {
    ...
    var result = numOfPairs(array1, k); // I know (baap ko mat sikha), I didn't call the function directly within the console.log() function because I wanted to type-check the function's return value
