...
function sumArray(array1: any) : number {
    ...
    let result : number = 0, min : number = Infinity, max : number = -Infinity;
...
function main() : void {
    let array1 : number[] = [], size : number = Number(prompt(`Enter the size of the array : `));
